...
//
//    public TodayScreen(List<Task> todayTasks, List<Task> freeTasks, List<Task> lateTasks, String day, String textNote, List<StudyClass> studyClasses) {
...
//    }
//
//    public TodayScreen(List<Task> tasks,String day, String textNote, List<StudyClass> studyClasses) {
//        this.tasks = tasks;
//        this.day = day;
//        this.textNote = textNote;
//        this.studyClasses = studyClasses;
